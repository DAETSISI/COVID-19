...
body { background: url(../img/fondo.jpg) no-repeat center center fixed; background-size: cover; font-family: arial, helvetica, sans-serif; }
...
#footer {background: #CCC; text-align: center; position: relative; top: 2000px}
