            ...
            <div class="container logo-nav-container"> 
                <nav class="navigation">
                    <ul class="row text-center">
                       ...
                       <div class = "col-md-2.4"> 
                           <li><a href="./subpaginas/ETSISI/etsisi.html">ETSISI</a></li>
                       </div>
                       <div class = "col-md-2.4"> 
                           <li><a href="./subpaginas/faq/faq.html">FAQs</a></li>
                       </div>
                       <div class = "col-md-2.4">
                           <li><a href="./subpaginas/FrenaLaCurva/flc.html">Frena la Curva</a></li>
                       </div>
                       <div class= "col-md-2.4">
                           <li><a href="./subpaginas/Documentacion/documentacion.html">Documentación</a></li>
                       </div>
                    </ul>  
                </nav>
            </div>
